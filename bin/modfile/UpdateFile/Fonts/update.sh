...
if [[ $deviceTYPE == "China" ]];then
    if [[ $rom_os == "MIUI" ]];then
        ...
        mods "Detect HalcyonOS A13!Adding..."
        ...
        cp -rf $work_dir/bin/modfile/UpdateFile/Fonts/HalcyonOS/*.ttf $work_dir/build/baserom/images/system/system/fonts/
	elif [[ $rom_os == "OS1" ]] && [[ $androidVer -le "14" ]];then
        mods "Detect HalcyonOS!Adding..."
		rm $work_dir/build/baserom/images/system/system/fonts/MiSansLatinVF.ttf
		rm $work_dir/build/baserom/images/system/system/fonts/MiSansVF.ttf
		rm $work_dir/build/baserom/images/system/system/fonts/MiSansVF_Overlay.ttf
        cp -rf $work_dir/bin/modfile/UpdateFile/Fonts/HalcyonOS/*.ttf $work_dir/build/baserom/images/system/system/fonts/
		cp -rf $work_dir/bin/modfile/UpdateFile/Fonts/HalcyonOS/A14/*.ttf $work_dir/build/baserom/images/product/fonts/
